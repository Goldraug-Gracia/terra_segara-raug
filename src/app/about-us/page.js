...
export default function AboutUs() {
  return (
    <>
      ...
      />
      <div className="w-screen h-screen max-sm:h-auto aspect-video relative">
        <Image
          ...
          priority // Optional: improves performance by loading this image first
        />
        <div className="absolute inset-0 bg-gradient-to-t from-white from-20% to-transparent flex justify-center items-end text-center text-secondary text-8xl max-sm:text-4xl font-bold p-6">
          About Us
        </div>
      </div>
      ...
      <div className="mt-24 max-sm:mt-0 max-w-full h-fit py-12 max-sm:py-8 mx-auto w-2/3 max-sm:text-xs max-sm:w-4/5 text-justify text-secondary text-xl max-sm:leading-snug">
        <h1 className="text-4xl max-sm:text-lg font-bold text-center">
          Who Are We?
        </h1>
        <br className="max-sm:invisible" />
        Yayasan Terra Segara Indonesia (YTSI) is a non-profit organization based
        in Nusa Penida, Bali. Its name is derived from the Sanskrit words
        "Terra'' which means land and "Segara'' which means sea. Our first point
        of departure is we believe that the dynamics of land, sea, and the
        people—all constituent parts of the earth—impact one another as a
        single, interconnected whole. Thus, as a responsible human being we have
        the prominent responsibility to maintain the balance between the two.
        The founders of YTSI are all diving instructors whom have been living
        and working in Nusa Penida Marine Protected Area (MPA) for more than
        five years.
      </div>
      ...
      <div className="w-2/3 h-fit mt-10 text-justify text-secondary text-xl max-sm:text-xs max-sm:leading-snug max-sm:w-4/5">
        <h1 className="text-4xl font-bold text-center max-sm:text-lg">
          What we do?
        </h1>
        <div className="my-12 max-sm:my-6">
          <Image
            src="/Website Asset/4.png" // Ensure the correct path for the image
            width={1280}
            height={720}
            alt="Image description"
            className="object-fill w-full h-auto" // Apply your desired styling
          />
        </div>
        <p className="">
          We are committed to addressing the challenges of coral degradation and
          ocean plastic pollution prevalent across the island. However, our
          primary aim extends beyond mere problem-solving; we are dedicated to
          instilling a shared sense of urgency and mobilizing collective efforts
          toward resolution. While these issues may not directly contribute to
          climate action, our overarching goal is to anchor the discourse of
          climate change and action in a substantive yet practical manner.
          Recognizing the global scope of climate change, we emphasize the
          importance of local engagement, advocating for solutions tailored to
          our immediate surroundings. To this end, we integrate the concept of
          cultural preservation, fostering a culturally relevant and accessible
      ...
      <div className="w-2/3 h-fit my-10 text-justify text-secondary text-xl max-sm:text-xs max-sm:leading-snug max-sm:w-4/5">
        ...
        />
        To effectively advance our overarching objective, we have identified
        ...
        <ol className="list-decimal list-outside text-secondary w-fit flex flex-col mx-auto -translate-x-16 max-sm:-translate-x-4">
          <li className="text-left ml-36 max-sm:ml-10">
            <b>Educate</b>: Climate change awareness must be disseminated
            through various educational avenues, including formal, informal, and
            non-formal channels. For instance, integrating climate change
            education into scuba dive training offers a hands-on approach and
            fosters engagement through experiential learning.
          </li>
          <li className="text-left ml-36 max-sm:ml-10">
            <b>Preserve</b>: While climate change predominantly impacts the
            environment, its adaptation necessitates addressing social and
            cultural dimensions. Therefore, efforts toward climate change
            adaptation should prioritize the preservation of local culture by
            honoring indigenous knowledge and traditional practices.
          </li>
          <li className="text-left ml-36 max-sm:ml-10">
            <b>Conserve</b>: By fostering education and cultural preservation,
            individuals become more cognizant of climate change and its
            implications, motivating them to actively participate in
            conservation efforts aimed at safeguarding both natural and cultural
            heritage.
          </li>
        </ol>
        <br />
        It is imperative to note that these agendas are dynamic and adaptable,
        evolving through participatory research methodologies. Operating on a
        collaborative basis with the community of Nusa Penida, we recognize
        their invaluable expertise and local wisdom as paramount. Hence, our
        approach is rooted in acknowledging and integrating their indigenous
        knowledge into our initiatives, placing their insights at the forefront
        of our endeavors.
      </div>
    </>
  );
